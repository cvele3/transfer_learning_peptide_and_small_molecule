...
##############################################################
PROCESSED_DATA_FILE = "../inflated_models/large_layers_overtrained_small_mol_tox_pred.pkl"
...
##############################################################
PRETRAINED_MODEL_PATH = "../inflated_models/inflated_peptide_model.h5"
...
for split in cv_splits:
    ...
    model_save_path = f"inflated_freeze_gnn_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
...
#     # Save the model for this fold with a unique filename
#     model_save_path = f"inflated_freeze_readout_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
...
#     # Save the model for this fold with a unique filename
#     model_save_path = f"inflated_freeze_all_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"inflated_gradual_unfreezing_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
