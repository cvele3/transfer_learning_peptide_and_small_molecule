...
##############################################################
PROCESSED_DATA_FILE = "../inflated_models/large_layers_overtrained_peptide.pkl"
...
##############################################################
PRETRAINED_MODEL_PATH = "../inflated_models/inflated_small_moll_tox_model.h5"
...
for split in cv_splits:
    ...
    model_save_path = f"inflated_freeze_gnn_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
#     # Save the model for this fold with a unique filename
#     model_save_path = f"inflated_freeze_readout_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
#     # Save the model for this fold with a unique filename
#     model_save_path = f"inflated_freeze_all_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    epochs_per_phase = 150  # Adjust number of epochs per phase as needed
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"inflated_gradual_unfreezing_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
