...
model_groups = {
    ...
    "Method 1 (Freeze GNN)": "../large_layers_transfer_learning_smt_to_p/LL_freeze_gnn_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 2 (Freeze Readout)": "../large_layers_transfer_learning_smt_to_p/LL_freeze_readout_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 3 (Freeze All)": "../large_layers_transfer_learning_smt_to_p/LL_freeze_all_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 4 (Gradual Unfreezing)": "../large_layers_transfer_learning_smt_to_p/LL_gradual_unfreezing_smile_mol_tox_to_peptide_fold_*.h5"
}
