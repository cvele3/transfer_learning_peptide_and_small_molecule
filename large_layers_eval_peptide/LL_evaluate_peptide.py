...
baseline_models = load_models_by_pattern("../large_layers_baseline_peptide/large_layers_baseline_peptide_fold_*.h5")
# Load the 10 models per transfer learning method
method1_models = load_models_by_pattern("../large_layers_transfer_learning_smt_to_p/LL_freeze_gnn_smile_mol_tox_to_peptide_fold_*.h5")
method2_models = load_models_by_pattern("../large_layers_transfer_learning_smt_to_p/LL_freeze_readout_smile_mol_tox_to_peptide_fold_*.h5")
method3_models = load_models_by_pattern("../large_layers_transfer_learning_smt_to_p/LL_freeze_all_smile_mol_tox_to_peptide_fold_*.h5")
method4_models = load_models_by_pattern("../large_layers_transfer_learning_smt_to_p/LL_gradual_unfreezing_smile_mol_tox_to_peptide_fold_*.h5")
