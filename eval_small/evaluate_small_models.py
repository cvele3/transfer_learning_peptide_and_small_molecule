...
PROCESSED_FILE = "../overtrained_models/overtrained_small_molecule_graphs.pkl"
...
baseline_models = load_models_by_pattern("../baseline_small/baseline_small_fold_*.h5")
# Load the 10 models per transfer learning method
method1_models = load_models_by_pattern("../transfer_learning_p_to_s/freeze_gnn_peptide_to_smile_fold_*.h5")
method2_models = load_models_by_pattern("../transfer_learning_p_to_s/freeze_readout_peptide_to_smile_fold_*.h5")
method3_models = load_models_by_pattern("../transfer_learning_p_to_s/freeze_all_peptide_to_smile_fold_*.h5")
method4_models = load_models_by_pattern("../transfer_learning_p_to_s/gradual_unfreezing_peptide_to_smile_fold_*.h5")
