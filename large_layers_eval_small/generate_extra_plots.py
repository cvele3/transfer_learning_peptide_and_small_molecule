...
# 1. Configuration
# Adjusted for large_layers_eval_small
PROCESSED_FILE = "../large_layers_models/large_layers_overtrained_small_coadd.pkl"
...
# Adjusted paths for large_layers_eval_small
model_groups = {
    "Baseline": "../large_layers_baseline_small_mol_tox/LL_baseline_small_mol_tox_fold_*.h5",
    "Method 1 (Freeze GNN)": "../large_layers_transfer_learning_p_to_smt/LL_freeze_gnn_peptide_to_small_mol_tox_fold_*.h5",
    "Method 2 (Freeze Readout)": "../large_layers_transfer_learning_p_to_smt/LL_freeze_readout_peptide_to_small_mol_tox_fold_*.h5",
    "Method 3 (Freeze All)": "../large_layers_transfer_learning_p_to_smt/LL_freeze_all_peptide_to_small_mol_tox_fold_*.h5",
    "Method 4 (Gradual Unfreezing)": "../large_layers_transfer_learning_p_to_smt/LL_gradual_unfreezing_peptide_to_small_mol_tox_fold_*.h5"
}
