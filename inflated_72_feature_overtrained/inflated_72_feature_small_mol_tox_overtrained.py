...
######################################
PROCESSED_DATA_FILE = "../cv_splits_features/overtrained_small_molecule_graphs_72_features.pkl"
...
if os.path.exists(PROCESSED_DATA_FILE):
    ...
    print("Ne postoji spremljena datoteka. Pokrenite prvo: cv_splits_features/create_graphs_72_features.py")
...
model.save('inflated_72_feature_small_moll_tox_model.h5')
