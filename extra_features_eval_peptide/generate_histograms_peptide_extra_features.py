...
baseline_models = load_models_by_pattern("../extra_features_baseline_peptide/baseline_peptide_fold_*.h5")
method1_models = load_models_by_pattern("../transfer_learning_extra_features_smt_to_p/freeze_gnn_small_mol_tox_to_peptide_fold_*.h5")
method2_models = load_models_by_pattern("../transfer_learning_extra_features_smt_to_p/freeze_readout_small_mol_tox_to_peptide_fold_*.h5")
method3_models = load_models_by_pattern("../transfer_learning_extra_features_smt_to_p/freeze_all_small_mol_tox_to_peptide_fold_*.h5")
method4_models = load_models_by_pattern("../transfer_learning_extra_features_smt_to_p/gradual_unfreezing_small_mol_tox_to_peptide_fold_*.h5")
