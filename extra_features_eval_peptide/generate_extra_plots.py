...
# 1. Configuration
# Adjusted for extra_features_eval_peptide
...
model_groups = {
    ...
    "Method 1 (Freeze GNN)": "../transfer_learning_extra_features_smt_to_p/extra_features_freeze_gnn_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 2 (Freeze Readout)": "../transfer_learning_extra_features_smt_to_p/extra_features_freeze_readout_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 3 (Freeze All)": "../transfer_learning_extra_features_smt_to_p/extra_features_freeze_all_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 4 (Gradual Unfreezing)": "../transfer_learning_extra_features_smt_to_p/extra_features_gradual_unfreezing_smile_mol_tox_to_peptide_fold_*.h5"
}
