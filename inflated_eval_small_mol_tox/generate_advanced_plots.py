...
# 1. Configuration
# Adjusted for inflated_eval_small_mol_tox
...
# 3. Model Loading
# Adjusted paths for inflated_eval_small_mol_tox
model_groups = {
    "Baseline": "../inflated_baseline_small_mol_tox/inflated_baseline_small_mol_tox_fold_*.h5",
    "Method 1": "../inflated_transfer_learning_p_to_smt/inflated_freeze_gnn_peptide_to_small_mol_tox_fold_*.h5",
    "Method 2": "../inflated_transfer_learning_p_to_smt/inflated_freeze_readout_peptide_to_small_mol_tox_fold_*.h5",
    "Method 3": "../inflated_transfer_learning_p_to_smt/inflated_freeze_all_peptide_to_small_mol_tox_fold_*.h5",
    "Method 4": "../inflated_transfer_learning_p_to_smt/inflated_gradual_unfreezing_peptide_to_small_mol_tox_fold_*.h5"
}
