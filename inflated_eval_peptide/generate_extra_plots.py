...
model_groups = {
    ...
    "Method 1 (Freeze GNN)": "../inflated_transfer_learning_smt_to_p/inflated_freeze_gnn_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 2 (Freeze Readout)": "../inflated_transfer_learning_smt_to_p/inflated_freeze_readout_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 3 (Freeze All)": "../inflated_transfer_learning_smt_to_p/inflated_freeze_all_smile_mol_tox_to_peptide_fold_*.h5",
    "Method 4 (Gradual Unfreezing)": "../inflated_transfer_learning_smt_to_p/inflated_gradual_unfreezing_smile_mol_tox_to_peptide_fold_*.h5"
}
