...
##############################################################
PRETRAINED_MODEL_PATH = "../inflated_72_feature_overtrained/inflated_72_feature_small_moll_tox_model.h5"
...
for split in cv_splits:
    ...
    model_save_path = f"inflated_72_feature_freeze_gnn_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"inflated_72_feature_freeze_readout_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"inflated_72_feature_freeze_all_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"inflated_72_feature_gradual_unfreezing_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
