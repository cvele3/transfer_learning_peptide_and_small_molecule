...
# 1. Load the same data used for training (Rich Features / Large Layers Data)
...
# 4. Load the saved model (The one trained with extra features)
custom_objects = {
...
model_path = 'extra_features_overtrained_small_molecule_mol_tox_model.h5'
...
if os.path.exists(model_path):
    ...
    print(f"Error: Model file {model_path} not found. Did you run the training script first?")
