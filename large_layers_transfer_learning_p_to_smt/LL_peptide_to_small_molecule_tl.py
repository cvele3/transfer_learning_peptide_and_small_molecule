...
##############################################################
PRETRAINED_MODEL_PATH = "../large_layers_models/larger_layers_peptide_model.h5"
...
for split in cv_splits:
    ...
    model_save_path = f"LL_freeze_gnn_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"LL_freeze_readout_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"LL_freeze_all_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"LL_gradual_unfreezing_peptide_to_smile_mol_tox_fold_{fold_index}.h5"
