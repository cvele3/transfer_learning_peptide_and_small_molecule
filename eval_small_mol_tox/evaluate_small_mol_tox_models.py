...
PROCESSED_FILE = "../overtrained_models/overtrained_small_molecule_mol_tox_pred_graphs.pkl"
...
SPLITS_FILE = "../cv_splits/cv_splits_small_mol_tox_pred_.pkl"
...
baseline_models = load_models_by_pattern("../baseline_small_mol_tox/baseline_small_mol_tox_fold_*.h5")
# Load the 10 models per transfer learning method
method1_models = load_models_by_pattern("../transfer_learning_p_to_smt/freeze_gnn_peptide_to_smile_mol_tox_fold_*.h5")
method2_models = load_models_by_pattern("../transfer_learning_p_to_smt/freeze_readout_peptide_to_smile_mol_tox_fold_*.h5")
method3_models = load_models_by_pattern("../transfer_learning_p_to_smt/freeze_all_peptide_to_smile_mol_tox_fold_*.h5")
method4_models = load_models_by_pattern("../transfer_learning_p_to_smt/gradual_unfreezing_peptide_to_smile_mol_tox_fold_*.h5")
