...
##############################################################
PRETRAINED_MODEL_PATH = "../overtrained_models/extra_features_overtrained_small_molecule_mol_tox_model.h5"
...
for split in cv_splits:
    ...
    model_save_path = f"freeze_gnn_small_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"freeze_readout_small_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"freeze_all_small_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"gradual_unfreezing_small_mol_tox_to_peptide_fold_{fold_index}.h5"
