"""
Script to create radar plots for SMT (Small Molecule Toxicity) models across three GNN layer configurations.
...
def evaluate_configuration(config_name, processed_file, splits_file, model_patterns):
    """Evaluate a single GNN layer configuration and return mean metrics."""
    print(f"\n{'='*60}")
    ...
    for group in model_groups:
        ...
        for metric in metric_names:
            ...
            if len(values) > 0:
                metrics_summary[group][metric] = np.mean(values)
            else:
...
def main():
    ...
    # Add main title
    fig.suptitle('SMT Models - Performance Comparison Across Layer Configurations', 
    ...
    # Save the figure
    output_file = "radar_plots_smt.png"
