...
##############################################################
PRETRAINED_MODEL_PATH = "../large_layers_models/larger_layers_small_moll_tox_model.h5"
...
#     model_save_path = f"LL_freeze_gnn_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
#     # Save the model for this fold with a unique filename
#     model_save_path = f"LL_freeze_readout_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
#     # Save the model for this fold with a unique filename
#     model_save_path = f"LL_freeze_all_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
...
for split in cv_splits:
    ...
    # Save the model for this fold with a unique filename
    model_save_path = f"LL_gradual_unfreezing_smile_mol_tox_to_peptide_fold_{fold_index}.h5"
